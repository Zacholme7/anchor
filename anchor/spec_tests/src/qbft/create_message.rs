...
use crate::utils::deserializers::{
    deserialize_base64, deserialize_base64_option, deserialize_create_type, deserialize_hex_hash256,
};
...
impl SpecTest for CreateMessageTest {
    fn setup(&mut self) {
        ...
        let starting_state = QbftStartingState {
            ...
            committee,
            operator_id,
            round: self.round.map(|r| Round::from(r)).unwrap_or(Round::from(0)),
